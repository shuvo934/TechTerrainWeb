...
class _ContactUsSectionState extends State<ContactUsSection>
  ...
  // static const _mapsEmbedAddress =
  //     'House #12, Road #17/A, Block #E, Banani, Dhaka-1213, Bangladesh';
...
class _LeftInfoBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final gradient = const LinearGradient(
      colors: [primary_color_light, Color(0xFFF8FAFF)],
    );
    const borderW = 5.0; // your GradientB
            ...
            child: Column(
              ...
              children: [
                _RowIconText(
                  ...
                  title: 'Address',
                  child: SelectableText(address, style: valueStyle),
                ),
...
class _RowIconText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, color: primary_color, size: 22),
        const SizedBox(width: 10),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
...
class _MapCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = const LinearGradient(
      colors: [Color(0xFFF8FAFF), primary_color_light],
    );
