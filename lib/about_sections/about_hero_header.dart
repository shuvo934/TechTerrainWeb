...
class AboutHeroHeader extends StatefulWidget {
  const AboutHeroHeader({super.key});

  @override
  State<AboutHeroHeader> createState() => _AboutHeroHeaderState();
}

class _AboutHeroHeaderState extends State<AboutHeroHeader>
                ...
                child: SlideTransition(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Building HealthTech, ERP, and GovTech solutions since 2010.',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.beVietnamPro(
                          fontSize: cfg.body,
